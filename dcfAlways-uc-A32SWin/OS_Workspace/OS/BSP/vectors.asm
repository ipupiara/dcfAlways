...
*********************************************************************************************************
*/
        .file    "EXCEPTION_VECTORS"

        .section .gcc_except_table, "ax"                                /* Exception Vector Table has to be aligned @ 0x1000        */
                                                                        /* boundary, otherwise interrupt auto-vectors do not work   */
                                                                        /* as expected.                                             */
                                                                        /* In the linker command file, a ". = ALIGN(0x1000);" has   */
                                                                        /* to be included in the .gcc_except_table (RO) section for */
                                                                        /* alignment.                                               */
...
*/
        ...
        .equ    VECTORS_INT0,                            0              /* Lowest interrupt priority level                          */
        .equ    VECTORS_INT1,                            1
        .equ    VECTORS_INT2,                            2
        .equ    VECTORS_INT3,                            3              /* Highest interrupt priority level                         */
...
__exception_stack:
        ...
        .weak   __unhandled_exception                                   /* weak definition of __unhandled_exception in case not     */
