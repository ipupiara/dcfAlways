...
// pn 11. jul 12, just for to see how asm files are integrated, lets add a method
// if this method should be further needed, I will transfer it from micrium files to own application files

CPU_INT32U  CPU_SysReg_Get_SR(void);
