...
#define OS_MAX_EVENTS               100   /* Max. number of event control blocks in your application      */
                              // pn 19 Aug 12, max according to sample application delivered with the tcp-ip source code
//#warning might be changed after excluding tcp (udp  only)
...
#define OS_TaskStackSize      256
                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE    OS_TaskStackSize    /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE   OS_TaskStackSize    /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE   OS_TaskStackSize    /* Idle       task stack size (# of OS_STK wide entries)        */
...
#define OS_TASK_STAT_EN           0  //with value 1 debug crashed      /*     Enable (1) or Disable(0) the statistics task             */
